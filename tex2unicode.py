...
def command_run_input(data, buffer, command):
    ...
    if command == "/input return": # enter was pressed
        ...
        weechatbuffer=unicode(weechatbuffer.replace('\\telephone',u'\u260F'))
        weechatbuffer=unicode(weechatbuffer.replace('\\heart',u'\u260F'))
        weechatbuffer=unicode(weechatbuffer.replace('\\square',u'\u2610'))
        weechatbuffer=unicode(weechatbuffer.replace('\\checkedbox',u'\u2764'))
        weechatbuffer=unicode(weechatbuffer.replace('\\TeX',u'T\u1D07X'))
        weechatbuffer=unicode(weechatbuffer.replace('\\LaTeX',u'L\u1D00T\u1D07X'))
        ...
        weechatbuffer=unicode(weechatbuffer.replace('\\frac12',u'\u00BD'))
        weechatbuffer=unicode(weechatbuffer.replace('\\frac14',u'\u00BC'))
        weechatbuffer=unicode(weechatbuffer.replace('\\frac34',u'\u00BE'))
        weechatbuffer=unicode(weechatbuffer.replace('\\frac13',u'\u2153'))
        weechatbuffer=unicode(weechatbuffer.replace('\\frac23',u'\u2154'))
        weechatbuffer=unicode(weechatbuffer.replace('\\frac15',u'\u2155'))
        weechatbuffer=unicode(weechatbuffer.replace('\\frac25',u'\u2156'))
        weechatbuffer=unicode(weechatbuffer.replace('\\frac35',u'\u2157'))
        weechatbuffer=unicode(weechatbuffer.replace('\\frac45',u'\u2158'))
        weechatbuffer=unicode(weechatbuffer.replace('\\frac16',u'\u2159'))
        weechatbuffer=unicode(weechatbuffer.replace('\\frac56',u'\u215A'))
        weechatbuffer=unicode(weechatbuffer.replace('\\frac18',u'\u215B'))
        weechatbuffer=unicode(weechatbuffer.replace('\\frac38',u'\u215C'))
        weechatbuffer=unicode(weechatbuffer.replace('\\frac58',u'\u215D'))
        weechatbuffer=unicode(weechatbuffer.replace('\\frac78',u'\u215E'))
